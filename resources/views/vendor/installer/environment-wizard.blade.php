...
@section('container')
    <div class="tabs tabs-full">
        ...
        <input id="tab1" type="radio" name="tabs" class="tab-input" {{!session()->has('tab') ? 'checked' : ''}} />
        ...
        <input id="tab2" type="radio" name="tabs" class="tab-input" {{session()->has('tab') && session('tab') == 'db' ? 'checked' : ''}} />
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="ChargePanda" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="{{get_base_url()}}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
