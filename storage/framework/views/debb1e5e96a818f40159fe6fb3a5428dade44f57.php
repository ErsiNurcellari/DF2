...
<?php $__env->startSection('container'); ?>
    ...
    <?php if( ! isset($permissions['errors'])): ?>
        <div class="buttons">
            <a href="<?php echo e(get_base_url('install/environment/wizard')); ?>" class="button">
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suf/sites/dacafilers/current/public/resources/views/vendor/installer/permissions.blade.php ENDPATH**/ ?>