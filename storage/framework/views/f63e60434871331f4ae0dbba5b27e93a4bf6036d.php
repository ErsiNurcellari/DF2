...
<?php $__env->startSection('container'); ?>
    <div class="tabs tabs-full">
        ...
        <input id="tab1" type="radio" name="tabs" class="tab-input" <?php echo e(!session()->has('tab') ? 'checked' : ''); ?> />
        ...
        <input id="tab2" type="radio" name="tabs" class="tab-input" <?php echo e(session()->has('tab') && session('tab') == 'db' ? 'checked' : ''); ?> />
        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group <?php echo e($errors->has('app_name') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="app_name" id="app_name" value="ChargePanda" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_name_placeholder')); ?>" />
                ...
                <div class="form-group <?php echo e($errors->has('environment') ? ' has-error ' : ''); ?>" style="display: none;">
                    ...
                    <select name="environment" id="environment" onchange='checkEnvironment(this.value);'>
                        ...
                        <option value="production" selected><?php echo e(trans('installer_messages.environment.wizard.form.app_environment_label_production')); ?></option>
                ...
                <div class="form-group <?php echo e($errors->has('app_url') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="url" name="app_url" id="app_url" value="<?php echo e(get_base_url()); ?>" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_url_placeholder')); ?>" />
                ...
                <div class="block">
                    ...
                    <div class="info">
                        <div class="form-group <?php echo e($errors->has('mail_driver') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_driver" id="mail_driver" value="mail" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_tabs.mail_driver_placeholder')); ?>" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suf/sites/dacafilers/current/public/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>